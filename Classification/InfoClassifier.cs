...
{
    // Info 文件的专属着色器
    internal class InfoClassifier : IClassifier
    {
    ...
    [Microsoft.VisualStudio.Utilities.ContentType("darkest-info")] // 只给 info 文件用
    internal class InfoClassifierProvider : IClassifierProvider
    {
        ...
        {
            return buffer.Properties.GetOrCreateSingletonProperty(() => new InfoClassifier(classificationRegistry));
        }
    }
}