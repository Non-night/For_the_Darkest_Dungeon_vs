...
{
	// Override 文件的专属着色器
	internal class OverrideClassifier : IClassifier
	{
	...
	// Override 文件的 Provider
	[System.ComponentModel.Composition.Export(typeof(IClassifierProvider))]
	[Microsoft.VisualStudio.Utilities.ContentType("darkest-override")] // 只给 override 文件用
	internal class OverrideClassifierProvider : IClassifierProvider
	{
		...
		{
			return buffer.Properties.GetOrCreateSingletonProperty(() => new OverrideClassifier(classificationRegistry));
		}
	}
}