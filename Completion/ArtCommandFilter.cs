...
namespace For_the_Darkest_Dungeon.Completion
{
	...
	/// Art 文件命令过滤器。
	///
	/// Art 文件与 Info / Override 文件在命令过滤与补全触发层面完全一致，
	/// 唯一差别只在于它挂接的文件类型不同。
	/// </summary>
	internal class ArtCommandFilter : BaseSharedInfoLikeCommandFilter
	{
		public ArtCommandFilter(IWpfTextView textView, ICompletionBroker broker)
